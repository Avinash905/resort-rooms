...
👉[Click here](https://Avinash905.github.io/resort-rooms) to check out the app.
<br/>

### 📃Features :

<ul>
<li>You can filter out rooms based on their type, price, size, breakfast facility, pets allowed or not, number of guests</li>
</ul>
